#include <stdint.h>
#ifdef  MAIN_FILE
volatile uint8_t G_posmenu, G_modo, G_linhaInst, G_vit, G_player, G_mux, debouncer;
volatile int G_selec_x, G_selec_y, G_cursor_x, G_cursor_y;
#else
extern volatile uint8_t G_posmenu, G_modo, G_linhaInst, G_vit, G_player, G_mux, debouncer;
extern volatile int G_selec_x, G_selec_y, G_cursor_x, G_cursor_y;
#endif
/*
